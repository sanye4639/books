...
@section('content')
   <script src="{{config('oss.OSSDomain')}}asset/js/echarts.min.js"></script>
                ...
                <div class="tpl-portlet">
                    ...
                    <div class="tpl-scrollable">
                        ...
                        <table class="am-table tpl-table">
                            ...
                            <tr>
                                <td>
                                    <img src="{{config('oss.OSSDomain')}}asset/img/user01.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="{{config('oss.OSSDomain')}}asset/img/user02.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="{{config('oss.OSSDomain')}}asset/img/user03.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="{{config('oss.OSSDomain')}}asset/img/user04.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="{{config('oss.OSSDomain')}}asset/img/user05.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="{{config('oss.OSSDomain')}}asset/img/user06.png" alt="" class="user-pic">
    ...
    <script src="{{config('oss.OSSDomain')}}asset/js/iscroll.js"></script>
