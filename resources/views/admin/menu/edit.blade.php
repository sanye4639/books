                                ...
                                <div class="am-u-sm-9">
                                    <select name="pid" data-am-selected="{maxHeight: 300}">
                                        ...
                                        @foreach($menu_list as $v)
                                            <option value="{{$v['id']}}" @if($menu['pid'] == $v->id ) selected @endif>{{$v['menu_name']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <div class="tpl-switch">
                                        <input type="checkbox" name="dstatus" class="ios-switch bigswitch tpl-switch-btn"  @if($menu['dstatus'] == 1) checked @endif />
