                    ...
                    <div class="tpl-form-body tpl-form-line">
                        <form class="am-form tpl-form-line-form" id="form" method="post" action="">
                            ...
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">书名 <span class="tpl-form-line-small-title">*</span></label>
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" name="name" value="{{ old('name','') }}" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-phone" class="am-u-sm-3 am-form-label">作者 <span class="tpl-form-line-small-title">*</span></label>
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" name="writer" value="{{ old('writer','') }}" required>
                                </div>
                            </div>

                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label">抓取url <span class="tpl-form-line-small-title">*</span></label>
                                <div class="am-u-sm-9">
                                    <input type="text" name="url" class="tpl-form-input" value="{{ old('url','') }}" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-phone" class="am-u-sm-3 am-form-label">小说分类</label>
                                <div class="am-u-sm-9">
                                    <select data-am-selected="{btnWidth: '40%', btnSize: 'sm', btnStyle: 'secondary'}" name="type">
                                ...
                                <div class="am-u-sm-9">
                                    <select data-am-selected="{btnWidth: '40%', btnSize: 'sm', btnStyle: 'secondary'}" name="tj">
                                        @foreach($tjArr as $k=>$v)
                                            <option value="{{$k}}" @if(old('tj','') == $k) selected @endif>{{$v}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-phone" class="am-u-sm-3 am-form-label">小说状态</label>
                                <div class="am-u-sm-9">
                                    <select data-am-selected="{btnWidth: '40%', btnSize: 'sm', btnStyle: 'secondary'}" name="over">
                                        <option value="1" @if(old('over','') == 1) selected @endif>连载</option>
                                        <option value="2" @if(old('over','') == 2) selected @endif>完结</option>
                                    </select>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <div class="am-form-group am-form-file">
                                        <input type="hidden" name="pic" id="fileBase64" value="{{old('pic','')}}">
                            ...
                            <div class="am-form-group">
                                <label for="user-intro" class="am-u-sm-3 am-form-label">小说简介 <span class="tpl-form-line-small-title">*</span></label>
                                <div class="am-u-sm-9">
                                    <textarea class="" rows="10" id="user-intro" name="intro" placeholder="请输入简介内容">{{old('intro','')}}</textarea>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <div class="tpl-switch">
                                        <input type="checkbox" name="dstatus" class="ios-switch bigswitch tpl-switch-btn" @if(old('dstatus','on') == 'on') checked @endif/>
