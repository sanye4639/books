                    ...
                    <div class="tpl-form-body tpl-form-line">
                        <form class="am-form tpl-form-line-form" id="form" method="post" action="">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" name="title" value="{{ old('title',$data['title'])}}" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">广告图片 <span class="tpl-form-line-small-title">Images</span></label>
                                <div class="am-u-sm-9">
                                    <div class="am-form-group am-form-file">
                                        ...
                                        <button type="button" class="am-btn am-btn-danger am-btn-sm">
                                            <i class="am-icon-cloud-upload"></i> 上传广告图片</button>
                                        <input id="doc-form-file upfile" type="file" name="upfile" capture="camera" accept="image/*">
                                    </div>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-phone" class="am-u-sm-3 am-form-label">栏目 <span class="tpl-form-line-small-title">Type</span></label>
                                <div class="am-u-sm-9">
                                    <select data-am-selected="{btnWidth: '40%', btnSize: 'sm', btnStyle: 'secondary'}" name="type">
                                        @foreach($tjArr as $k=>$v)
                                            <option value="{{$k}}" @if(old('type',$data['type']) == $k) selected @endif>{{$v}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-intro" class="am-u-sm-3 am-form-label">是否显示 <span class="tpl-form-line-small-title">Dstatus</span></label>
                                <div class="am-u-sm-9">
