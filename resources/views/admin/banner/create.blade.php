                    ...
                    <div class="tpl-form-body tpl-form-line">
                        <form class="am-form tpl-form-line-form" id="form" method="post" action="">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" name="title" value="{{ old('title','') }}" required>
                                </div>
                            </div>

                            <div class="am-form-group">
                                <label for="user-phone" class="am-u-sm-3 am-form-label">栏目 <span class="tpl-form-line-small-title">*</span></label>
                                <div class="am-u-sm-9">
