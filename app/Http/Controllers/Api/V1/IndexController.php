...
class IndexController extends Controller{
    ...
    */
    function index(Request $request){
         ...
         * */
        $home_data = DB::select("SELECT a.id,a.name,a.pic,a.writer,a.intro,a.over,a.type,a.tj FROM book_list AS a,(SELECT GROUP_CONCAT(id order by sort desc) AS ids FROM book_list where dstatus = 1 and tj >0 GROUP BY tj) AS b WHERE FIND_IN_SET(a.id, b.ids) BETWEEN 1 AND 3 ORDER BY a.tj ASC, a.sort DESC");
