 ...
 * return 中文类型名称
 * */
function get_bookType2($type){
    switch ($type){
        case 0:
            return [
                array('id'=>1,'name'=>'玄幻奇幻'),
                array('id'=>2,'name'=>'武侠仙侠'),
                array('id'=>3,'name'=>'都市言情'),
                array('id'=>4,'name'=>'穿越小说'),
                array('id'=>5,'name'=>'网游竞技'),
                array('id'=>6,'name'=>'科幻灵异'),
                array('id'=>7,'name'=>'历史军事'),
                array('id'=>8,'name'=>'女生频道'),
                array('id'=>9,'name'=>'同人小说'),
            ];
        case 1:
            return '玄幻奇幻';
        case 2:
