...
class OSS {
    ...
    public function __construct($isInternal = false)
    {
        ...
        $this->city  = config('oss.AccessCity');
    ...
    public static function publicDeleteObject($bucketName, $ossKey)
    {
        ...
        if(is_array($ossKey)){
            foreach($ossKey as $v){
                $oss->ossClient->deleteObject($bucketName, $v);
            }
        }else{
    ...
    public static function getAllObjectKeyWithPrefix($bucketName, $folder_name)
    {
        $oss = new OSS();
        return $oss->ossClient->getAllObjectKeyWithPrefix($bucketName, $folder_name);
    }
